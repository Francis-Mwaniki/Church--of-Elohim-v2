  ...
  <footer class="text-center bg-slate-900 text-white">
    <div class="container px-6 pt-6">
        ...
        <form action="">
          <div class="grid md:grid-cols-3 gird-cols-1 gap-4 justify-center items-center">
            ...
            <div class="md:mr-auto mb-6">
              <button
                type="submit"
                class="inline-block px-6 py-3 text-white font-medium text-xs leading-tight uppercase rounded hover:bg-white bg-gradient-to-r from-indigo-400 via-indigo-600 to-indigo-700 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
              >
                Subscribe
              </button>
            </div>
      ...
      <div class="grid lg:grid-cols-4 md:grid-cols-2">
        <div class="mb-6">
          <h5 class="uppercase font-bold mb-2.5 border-white mx-auto border-b-2 pb-1">
            Policy
          </h5>
